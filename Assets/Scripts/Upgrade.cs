...
public class Upgrade : MonoBehaviour {
	...
	private Rect windowRect0 = new Rect(20, 20, 370, 80);
	private Rect windowRect1 = new Rect(20, 100, 770, 80);
	//Start making Buttons
	void OnGUI() {
		doWindow0 = GUI.Toggle(new Rect(10, 10, 200, 30), doWindow0, "Window 0");
		doWindow1 = GUI.Toggle(new Rect(10, 40, 400, 20), doWindow1, "Window 1");
			if (doWindow0)
			{
